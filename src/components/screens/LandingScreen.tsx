...
export const LandingScreen: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col justify-between selection:bg-blue-600 selection:text-white">
      ...
      <header className="h-16 border-b border-slate-800/80 px-8 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4 text-xs">
          ...
          <button
            ...
            className="px-3.5 py-1.5 rounded bg-slate-900 hover:bg-slate-800 text-slate-200 border border-slate-700 transition-colors font-medium"
          >
            Launch Demo
          </button>
        </div>
      ...
      {/* Hero Section */}
      <main className="flex-1 flex flex-col justify-center px-6 lg:px-16 py-12 max-w-6xl mx-auto w-full">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-3.5 pt-2">
              <button
                ...
                onClick={handleLaunchDemo}
                className="flex items-center gap-2 px-5 py-3 rounded-md bg-blue-600 hover:bg-blue-500 text-white font-medium text-sm transition-all shadow-lg shadow-blue-600/20"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 px-5 py-3 rounded-md bg-slate-900 hover:bg-slate-800 text-slate-200 border border-slate-800 text-sm font-medium transition-colors"
              >
          ...
          <div className="lg:col-span-5">
            <div className="bg-slate-900/90 border border-slate-800 rounded-xl p-6 shadow-2xl backdrop-blur-sm space-y-4">
              ...
              <div className="space-y-2 text-xs">
                {[
                  ...
                  >
                    <span className="font-mono text-[11px] text-blue-400 font-semibold mt-0.5">{item.step}</span>
                    <div>
              ...
              <div className="pt-2 border-t border-slate-800 space-y-1.5">
                ...
                <div className="grid grid-cols-1 gap-1.5">
                  {availableProjects.map((p) => (
                    ...
                    >
                      <span className="group-hover:text-blue-300 transition-colors">{p.identity.name}</span>
      ...
      {/* Footer */}
      <footer className="border-t border-slate-800/80 px-8 py-4 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-400 gap-2">
